 ...
 * The main sources of inputs are the controller and the buttons.
 * The inputs from the buttons are read from pressing.
 * The inputs from the controller are read from tilting.
